...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__wobble" src="<?php echo e(asset('template/dist/img/PGlogo.png')); ?>" alt="logoPG" height="100" width="100">
  </div>
  ...
  <aside class="main-sidebar elevation-4">
    ...
    <a class="brand-link" style="text-decoration: none !important;">
      <img src="<?php echo e(asset('template/dist/img/PGlogo.png')); ?>"  class="brand-image img-circle elevation-3">
...
<div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
        <div class="image d-flex align-items-center justify-content-center" style="width: 30px; height: 30px;">
            ...
            ?>
            <img src="<?php echo e(asset('template/dist/img/pengguna.png')); ?>" class="img-circle elevation-4" alt="Image">
        </div>
        <div class="info ml-2">
          <span>Selamat Datang </span>
            <span class="d-block" style="font-weight:bold;"><?php echo e(auth()->user()->nama); ?></span>
        </div>
    </div>
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview <?php echo e(Request::is('kategori*') || Request::is('room*') || Request::is('aset*') ? 'menu-open' : ''); ?>">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="/kategori" class="nav-link <?php echo e(Request::is('kategori') ? 'active' : ''); ?>">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Kategori Aset</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/room" class="nav-link <?php echo e(Request::is('room') ? 'active' : ''); ?>">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Ruang</p>
                    </a>
                </li>
                <li class="nav-item">
                  <a href="/aset" class="nav-link <?php echo e(Request::is('aset') || Request::is('/tambahaset') || Request::is('/tampildata/{id}*') ? 'active' : ''); ?>">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Data Aset</p>
                    </a>
                </li>
          ...
          <li class="nav-item <?php echo e(Request::is('/transaksipinjam*') ? 'menu-open' : ''); ?>">
            <a href="/transaksipinjam" class="nav-link <?php echo e(Request::is('/transaksipinjam*') ? 'active' : ''); ?>">
                <i class="nav-icon fas fa-hand-holding"></i>
                <p>Transaksi</p>
            </a>
        </li>
          <li class="nav-item <?php echo e(Request::is('/adminpengaduan*') ? 'menu-open' : ''); ?>">
            <a href="/adminpengaduan" class="nav-link <?php echo e(Request::is('/adminpengaduan*') ? 'active' : ''); ?> ">
...
<script>
  $(document).ready(function() {
    function fetchNotifications() {
        $.ajax({
            url: '<?php echo e(route('notifikasipinjam')); ?>',
            method: 'GET',
...
<?php /**PATH C:\Users\user\codemagang\projectaset\resources\views/layout/admin.blade.php ENDPATH**/ ?>