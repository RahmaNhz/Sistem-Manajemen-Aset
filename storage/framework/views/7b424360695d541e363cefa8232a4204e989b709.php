...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <!-- Messages Dropdown Menu -->
          ...
          <div class="navbar-nav">
            <div class="row">
                <div class="col">
                    <a class="navbar-brand" href="<?php echo e(route('pengaduan')); ?>" title="Pengaduan">
                        <i class="nav-icon fas fa-question-circle" style="color:white"></i> <!-- Ikon "Pengaduan" dari Font Awesome -->
                    </a>
                </div>
  ...
  <aside class="main-sidebar elevation-4">
    ...
    <a href="/" class="brand-link" style="text-decoration: none !important;">
      <img src="<?php echo e(asset('template/dist/img/PGlogo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php echo e(Request::is('pegawai/aset*') ? 'menu-open' : ''); ?>">
            <a href="/pegawai/aset" class="nav-link <?php echo e(Request::is('pegawai/aset*') ? 'active' : ''); ?>">
          ...
          <li class="nav-item <?php echo e(Request::is('/daftarpinjam*') ? 'menu-open' : ''); ?>">
            <a href="/daftarpinjam" class="nav-link <?php echo e(Request::is('/daftarpinjam*') ? 'active' : ''); ?>">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 <a href="https://adminlte.io">SIMAS</a>.</strong>
    PSDMO.
...
<?php /**PATH C:\Users\user\codemagang\projectaset\resources\views/layout/pegawai.blade.php ENDPATH**/ ?>