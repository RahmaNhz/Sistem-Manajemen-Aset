      ...
      <div class="row">
        ...
        {{-- <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Aset Dipinjam</span>
        ...
        {{-- <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <a href="/daftarpengembalian" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div> --}}
        ...
        {{-- <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Aset Kembali</span>
              <span class="info-box-number">{{ $totalAsetDikembalikan }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Pengaduan Diajukan</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{  $jumlahPengaduanSelesai }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <ul class="products-list product-list-in-card pl-2 pr-2">
                ...
                <li class="item">
                  <div class="product-img">
                    <img src="{{ asset('template/dist/img/default-150x150.pn') }}g" alt="Product Image" class="img-size-50">
                  </div>
                  <div class="product-info">
