      ...
      <div class="container container-center">
          <div class="row justify-content-center">
              <div class="col-8">
                  <div class='card'>
                      <div class="card-body">
                          <form action="/editkategori/{{ $data->id }} "method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class="mb-3">
                                <label for="namakategori" class="form-label">Nama Aset</label>
                                <input type="text" name='nama_kategori' class="form-control" id="nama_kategori" aria-describedby="emailHelp" value="{{ $data->nama_kategori }}">
                              </div>
