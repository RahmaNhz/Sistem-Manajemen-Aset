      ...
      {{-- <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="navbar-nav">
            <div class="row">
                <div class="col">
                    <a class="navbar-brand" href="{{ route('pengaduan') }}" title="Pengaduan">
                        <i class="nav-icon fas fa-question-circle" style="color:white"></i> <!-- Ikon "Pengaduan" dari Font Awesome -->
                    </a>
                </div>

                {{-- <div class="col" style="margin-left: -35px;"> <!-- Mengatur margin kiri untuk mengurangi jarak -->
                    <a class="navbar-brand" href="/logout" title="Logout">
                        <i class="nav-icon fas fa-sign-out-alt"></i> <!-- Ikon "Pengaduan" dari Font Awesome -->
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{ Request::is('pegawai/aset*') ? 'menu-open' : '' }}">
            <a href="/pegawai/aset" class="nav-link {{ Request::is('pegawai/aset*') ? 'active' : '' }}">
          ...
          <li class="nav-item {{ Request::is('/daftarpinjam*') ? 'menu-open' : '' }}">
            <a href="/daftarpinjam" class="nav-link {{ Request::is('/daftarpinjam*') ? 'active' : '' }}">
...
{{-- 
          <li class="nav-item">
            <a href="/daftarpinjam" class="nav-link">
              <i class="nav-icon fas fa-hand-holding"></i>
              Peminjaman
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="/daftarpengembalian" class="nav-link">
